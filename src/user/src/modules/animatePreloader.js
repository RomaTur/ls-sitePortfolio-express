...
module.exports = () => {
  ...
  let animatePreloader = () => {
    ...
    .then(function(status){
        ...
        if(document.querySelector('.header'))document.querySelector('.header').style.backgroundImage = 'url("../../user/dist/bg.jpg")'
        if(document.querySelector('.welcome'))document.querySelector('.welcome').style.backgroundImage = 'url("../../user/dist/bg.jpg")'
        document.querySelector('.parallax').style.display = 'none'
    })
